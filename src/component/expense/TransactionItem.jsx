...
const TransactionItem = ({ amount, title, type, createdAt, onDelete }) => {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -20 }}
      className="bg-gray-750 rounded-lg p-3 sm:p-4 transition-all duration-300 hover:bg-gray-700 hover:shadow-lg"
    >
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <p className="text-sm sm:text-base font-semibold text-gray-100 truncate max-w-[120px] sm:max-w-[150px] md:max-w-[200px]">
            {title}
          </p>
        </div>
        <button
