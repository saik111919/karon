      ...
      <nav className='bg-blue-700 lg:flex block w-screen lg:relative fixed bottom-0'>
        <div className='block lg:flex flex-1'>
          <div className='lg:flex hidden'>
            <NavLink to={"/karon"} className={"p-3 self-center"}>
              KARON
            </NavLink>
          </div>
          <ul className='list-none flex align-middle justify-between lg:justify-start lg:gap-0.5'>
            <li className='flex'>
              <NavLink
                to='/karon/'
                className={`p-3 self-center hover:border-b-2 flex gap-1 align-middle ${
                  location.pathname === "/karon/"
            ...
            <li className='flex'>
              <NavLink
                to='/karon/expense'
                className={`p-3 self-center hover:border-b-2 flex gap-1 align-middle ${
                  location.pathname === "/karon/expense"
                    ? "bg-blue-600 text-white border-b-2"
                    : "hover:bg-blue-600 hover:text-white"
                }`}
              >
            ...
            <li className='lg:hidden flex'>
              <NavLink
                to='/karon/settings'
                className={`p-3 self-center hover:border-b-2 flex gap-1 align-middle ${
                  location.pathname === "/karon/settings"
                    ? "bg-blue-600 text-white border-b-2"
                    : "hover:bg-blue-600 hover:text-white"
                }`}
              >
